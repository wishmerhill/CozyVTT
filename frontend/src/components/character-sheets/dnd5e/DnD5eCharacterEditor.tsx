...
min={0}
      ...
      <div className="bg-stone-50 border border-stone-200 rounded-lg p-4">
        ...
        <div className="grid grid-cols-[minmax(0,1fr)_5.5rem_3.5rem_0.75rem_3.5rem_1.75rem] gap-2 items-center mb-1">
          ...
          <label className="text-xs font-semibold text-stone-600 text-center">{t('sheet.hitDiceDieHeader')}</label>
          <label className="text-xs font-semibold text-stone-600 text-center">{t('sheet.hitDiceLeftHeader')}</label>
          <span aria-hidden="true" />
          <label className="text-xs font-semibold text-stone-600 text-center">{t('sheet.hitDiceMaxHeader')}</label>
          <span aria-hidden="true" />
        </div>
        <div className="space-y-2">
          {(formData.hitDice || []).map((die, index) => (
            <div key={index} className="grid grid-cols-[minmax(0,1fr)_5.5rem_3.5rem_0.75rem_3.5rem_1.75rem] gap-2 items-center">
              ...
              <input
                ...
                placeholder="d10"
                aria-label={t('sheet.hitDieAriaLabel')}
                title={t('sheet.hitDieTitle')}
              ...
              <NumberField
                ...
                aria-label={t('sheet.hitDiceLeftAriaLabel')}
                title={t('sheet.hitDiceLeftTitle')}
              ...
              <NumberField
                ...
                aria-label={t('sheet.hitDiceMaxAriaLabel')}
                title={t('sheet.hitDiceMaxTitle')}
                className="min-w-0 px-1 py-1 border border-stone-300 rounded text-center focus:outline-none focus:ring-2 focus:ring-red-500"
                fallback={0}
              />
              <button
                ...
                aria-label={t('sheet.removeHitDie', { class: die.class || t('sheet.hitDiceFallbackClass') })}
                title={t('sheet.removeHitDieTitle')}
        ...
        <p className="mt-2 text-xs text-stone-500">
          <Trans
            i18nKey="character:sheet.hitDiceHelpText"
